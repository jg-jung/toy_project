package com.company.mypage.web.domain.posts.service;

import java.util.List;
import java.util.stream.Collectors;

import com.company.mypage.web.domain.posts.domain.entity.PostsComment;
import com.company.mypage.web.domain.posts.dto.*;
...
import com.company.mypage.web.domain.posts.domain.repository.CommentRepository;
import com.company.mypage.web.domain.posts.domain.repository.PostsRepository;
